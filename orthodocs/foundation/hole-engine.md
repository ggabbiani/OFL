...
```text
fl_Hole(position,d,normal=+Z,depth=0,ldir,loct,nop_screw)
```
...
__nop_screw__  
OPTIONAL full screw specifications as returned from [fl_screw_specs()](../vitamins/screw.md#function-fl_screw_specs) property.

:memo: **NOTE:** this is a NopSCADlib object.
