...
__proto__  
prototype with [fl_director()](defs.md#function-fl_director) and [fl_rotor()](defs.md#function-fl_rotor) properties
...
__Syntax:__
    ...
    fl_linear_extrude(source=[Z,X],direction,length,convexity=10)
