...
graph TD
    ...
    A33 --o|include| A19
    A33 --o|include| A40[vitamins/trimpot]
    A33 --o|include| A41[vitamins/usbs]
    A33 --o|use| A25
    A39 --o|include| A21
    A39 --o|include| A12
    A39 --o|include| A34
    A39 --o|include| A17
    A16 --o|include| A3
    A42[vitamins/psus] --o|include| A27
    A42 --o|include| A30
    A42 --o|include| A2
    A42 --o|include| A17
    A42 --o|include| A19
    ...
    A31 --o|include| A21
    A31 --o|include| A24
    A43[vitamins/sata-adapters] --o|include| A31
    A19 --o|include| A3
    A19 --o|include| A2
    A14 --o|include| A30
    A14 --o|include| A36
    A14 --o|include| A2
    A14 --o|include| A18
    A44[vitamins/spdts] --o|include| A3
    A22 --o|include| A45[foundation/torus]
    A46[artifacts/template] --o|include| A2
    A47[foundation/template] --o|include| A30
    A48[vitamins/template] --o|include| A12
    A45 --o|include| A3
    A40 --o|include| A3
    A40 --o|include| A4
    A40 --o|include| A2
