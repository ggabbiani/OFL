...
graph TD
    ...
    A27 --o|use| A7
    A31[vitamins/jacks] --o|include| A19
    A31 --o|include| A30
    A31 --o|include| A32[foundation/tube]
    A31 --o|use| A5
    A31 --o|use| A4
    A31 --o|use| A16
    A12 --o|include| A13
    ...
    A36 --o|use| A3
    A36 --o|use| A4
    A37[vitamins/pcbs] --o|include| A18
    A37 --o|include| A24
    A37 --o|include| A27
    A37 --o|include| A30
    A37 --o|include| A22
    ...
    A15 --o|use| A5
    A15 --o|use| A4
    A43[vitamins/psus] --o|include| A24
    A43 --o|include| A27
    A43 --o|include| A2
    A43 --o|include| A13
    A43 --o|use| A4
    ...
    A50[foundation/torus] --o|include| A2
    A50 --o|use| A1
    A50 --o|use| A5
    A50 --o|use| A4
    A41 --o|include| A2
