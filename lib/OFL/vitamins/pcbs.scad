    ...
    module do_cutout() {
      ...
      module trigger() {
        ...
        if ($comp_engine==FL_USB_NS)
          ...
          fl_ether(FL_CUTOUT,$comp_type,$fl_thickness=cut_thick-$comp_drift,$fl_tolerance=$fl_tolerance,cut_drift=$comp_drift,cut_direction=fl_comp_actualCuts(cut_direction),octant=$comp_octant,direction=$comp_direction);
