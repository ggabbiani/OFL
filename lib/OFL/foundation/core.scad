 ...
 * **Usage**
 *
 * when implementing this verb inside a fl_vmanage{} loop, its typical usage is
 * the following:
 *
 *     ...
 ...
 * | -------------- | ----------------- | ----------------------- | ------------------------------------------------- |
 * | cut_dirs       | parameter         | Object 'preferred' ones as returned by the fl_cutout() property | list of semi-axes indicating the cutout directions. |
