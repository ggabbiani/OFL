...
include <../../vitamins/MCXJPHSTEM1.scad>
...
MCXJPHSTEM1(verbs,MCXJPHSTEM1,cut_thick=thick,cut_tolerance=tolerance,cut_drift=drift,direction=direction,octant=octant);