...
knut          = KNUT_TYPE!="none" ? assert(scr_size,"***TEST ERROR***: specify a screw size for knut") fl_knut_select(thread=KNUT_TYPE,nominal=scr_size,best=FL_KNUT_SHORTEST) : undef;
